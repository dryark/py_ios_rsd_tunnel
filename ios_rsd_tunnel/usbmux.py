    ...
    def create_usbmux_socket(
        ...
        try:
            if usbmux_address is not None:
                ...
                address = MuxConnection.USBMUXD_PIPE # hardcoding for macOS
                family = socket.AF_UNIX
