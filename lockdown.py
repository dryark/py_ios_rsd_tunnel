...
class LockdownClient(ABC, LockdownServiceProvider):
    ...
    def create(
        ...
        pairing_records_cache_folder: Path = None, # location to search and save pair records
        port: int = SERVICE_PORT,         # lockdownd service port
        private_key: Optional[PrivateKey] = None, # custom RSA key for pairing purposes, if None it will be autogenerated
    ...
    def pair(
        ...
        cert_pem, private_key_pem, device_certificate_pem = ca_do_everything(
